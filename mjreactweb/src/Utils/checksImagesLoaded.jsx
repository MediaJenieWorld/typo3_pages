...
export function checkAllImagesLoaded(className) {
    const header = document.querySelector(".header1")
    const images = document.querySelectorAll(header.nextSibling.className + "img"); // Select all image elements
    let notLoaded = []
...
export function promiseImgLoaded(className) {
